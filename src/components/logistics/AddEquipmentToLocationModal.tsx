// src/components/logistics/AddEquipmentToLocationModal.tsx
// Modal for selecting equipment from master inventory to add to a specific location
...
interface AddEquipmentToLocationModalProps {
  isOpen: boolean;
  onClose: () => void;
...
export function AddEquipmentToLocationModal({
  isOpen,
  onClose,
  onAddEquipment,
  category,
  locationName
}: AddEquipmentToLocationModalProps) {
  ...
  const handleAdd = () => {
    ...
    toast.success(`Added ${selectedEquipment.name} to ${locationName}`);
    onClose();
  };
    ...
    <div className="fixed inset-0 bg-black bg-opacity-50 z-50 flex items-center justify-center p-4">
      <div className="bg-white rounded-lg shadow-xl max-w-3xl w-full max-h-[90vh] overflow-hidden flex flex-col">
        ...
        <div className="px-6 py-4 border-b border-gray-200 flex items-center justify-between">
          <div>
            <h2 className="text-2xl font-bold text-gray-800">Add Equipment to Location</h2>
            <p className="text-sm text-gray-500 mt-1">
              Adding to: <span className="font-semibold">{locationName}</span>
            </p>
          </div>
          <button
            ...
            <div className="space-y-4 pt-4 border-t border-gray-200">
              ...
              <div>
                ...
                <textarea
                  ...
                  rows={3}
                  placeholder="Add any specific requirements or notes for this location..."
                  className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500"
                />
              </div>
            </div>
