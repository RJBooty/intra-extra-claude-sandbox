...
const currentUser = {
  ...
  email: 'sarah.johnson@casfid.com',
                  ...
                  <div className="flex-1">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                      <div className="flex items-center gap-2">
                        ...
                        <span className="text-[#5c728a] text-sm">{currentUser.role}</span>
                      </div>
                      <div className="flex items-center gap-2">
                      ...
                      <div className="flex items-center gap-2">
                        ...
                        <span className="text-[#5c728a] text-sm">{currentUser.department}</span>
                      </div>
                      <div className="flex items-center gap-2">
                        <Calendar className="w-4 h-4 text-[#5c728a]" />
                        <span className="text-[#5c728a] text-sm">Joined {new Date(currentUser.joinDate).toLocaleDateString('en-US', { month: 'long', year: 'numeric' })}</span>
                      </div>
                    </div>
                  </div>
                </div>
