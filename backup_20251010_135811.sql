...
CREATE OR REPLACE FUNCTION "public"."create_bootstrap_master_user"("user_email" "text", "user_first_name" "text", "user_last_name" "text") RETURNS "void"
    LANGUAGE "plpgsql" SECURITY DEFINER
    AS $$
DECLARE
  v_user_id UUID;
...
ALTER FUNCTION "public"."create_bootstrap_master_user"("user_email" "text", "user_first_name" "text", "user_last_name" "text") OWNER TO "postgres";
...
CREATE OR REPLACE FUNCTION "public"."get_system_setting"("key_name" "text") RETURNS "text"
    LANGUAGE "plpgsql" SECURITY DEFINER
    AS $$
DECLARE
  setting_val TEXT;
...
ALTER FUNCTION "public"."get_system_setting"("key_name" "text") OWNER TO "postgres";
...
CREATE OR REPLACE FUNCTION "public"."update_system_setting"("key_name" "text", "new_value" "jsonb", "user_id" "uuid") RETURNS boolean
    LANGUAGE "plpgsql" SECURITY DEFINER
    AS $$
DECLARE
  user_role TEXT;
...
ALTER FUNCTION "public"."update_system_setting"("key_name" "text", "new_value" "jsonb", "user_id" "uuid") OWNER TO "postgres";
...
CREATE TABLE IF NOT EXISTS "public"."system_settings" (
    ...
    "created_at" timestamp with time zone DEFAULT "now"(),
    "updated_at" timestamp with time zone DEFAULT "now"(),
    CONSTRAINT "system_settings_setting_type_check" CHECK (("setting_type" = ANY (ARRAY['boolean'::"text", 'string'::"text", 'number'::"text", 'object'::"text"])))
);
...
CREATE OR REPLACE TRIGGER "trigger_update_system_settings_updated_at" BEFORE UPDATE ON "public"."system_settings" FOR EACH ROW EXECUTE FUNCTION "public"."update_system_settings_updated_at"();
...
CREATE POLICY "Anyone can view system settings" ON "public"."system_settings" FOR SELECT USING (("auth"."role"() = 'authenticated'::"text"));
...
CREATE POLICY "Authenticated users can manage system settings" ON "public"."system_settings" USING (("auth"."role"() = 'authenticated'::"text"));
...
CREATE POLICY "Users can view roles" ON "public"."user_roles" FOR SELECT USING (("auth"."role"() = 'authenticated'::"text"));
...
GRANT ALL ON FUNCTION "public"."create_bootstrap_master_user"("user_email" "text", "user_first_name" "text", "user_last_name" "text") TO "anon";
GRANT ALL ON FUNCTION "public"."create_bootstrap_master_user"("user_email" "text", "user_first_name" "text", "user_last_name" "text") TO "authenticated";
GRANT ALL ON FUNCTION "public"."create_bootstrap_master_user"("user_email" "text", "user_first_name" "text", "user_last_name" "text") TO "service_role";
...
GRANT ALL ON FUNCTION "public"."get_system_setting"("key_name" "text") TO "anon";
GRANT ALL ON FUNCTION "public"."get_system_setting"("key_name" "text") TO "authenticated";
GRANT ALL ON FUNCTION "public"."get_system_setting"("key_name" "text") TO "service_role";
...
GRANT ALL ON FUNCTION "public"."update_system_setting"("key_name" "text", "new_value" "jsonb", "user_id" "uuid") TO "anon";
GRANT ALL ON FUNCTION "public"."update_system_setting"("key_name" "text", "new_value" "jsonb", "user_id" "uuid") TO "authenticated";
GRANT ALL ON FUNCTION "public"."update_system_setting"("key_name" "text", "new_value" "jsonb", "user_id" "uuid") TO "service_role";
